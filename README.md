...
4. Beispiel: Task-Zuweisung kompakt
Phase	Aufgabe	Person(en)
1	Repo, Solution, Architektur	A
2	ER-Diagramm, SQL, DB-Setup	B
3	Domain + Incident/User Services	A
3	Logging, Repos	B
4	AuthService, Redis SessionStore	A + B
4	API-Controller	A + C
5	Frontend/Konsolenclient	C
6	Dockerfiles + docker-compose	B
7	Tests, SAST, Security-Doku	D
8	README, SBOM, CI	D + B
